...
Phase 1 failed before the VM could be updated to the candidate release images. Retention evidence against the old runtime would not validate the candidate.
