...
Phase 1 failed before the VM could be updated to the candidate release images. The performance harness must use the current candidate SHA as the tested runtime and fixture ref.
